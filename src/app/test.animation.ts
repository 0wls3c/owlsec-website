...
export function AnimateText(input?: any) {
//   class ShapeShifter {
//     x?: any;
//     y?: any;
//     z?: any;
...
//       } else {
//         this.UI().simulate('Shape|Shifter|Type|to start|#rectangle|#countdown 3||');
//       }
...
//       context: any,
//       renderFn: any,
//       requestFrame: any = window.requestAnimationFrame ||
...
//         drawCircle: function (p: any, c: any) {
...
//     };
//     UI() {
//       let input: any = document.querySelector('.shapeshift-text'),
//       ui: any = document.querySelector('.ui'),
//       help: any = document.querySelector('.help'),
//       commands: any = document.querySelector('.commands'),
//       overlay: any = document.querySelector('.overlay'),
//       canvas: any = document.querySelector('.canvas'),
//       interval: any,
//       isTouch: any = false, //('ontouchstart' in window || navigator.msMaxTouchPoints),
//       currentAction: any,
//       resizeTimer: any,
//       time: any,
//       maxShapeSize = 30,
//       firstAction: any = true,
//       sequence: any = [],
//       cmd: any = '#';
...
//       function getAction(value: any) {
//         value = value && value.split(' ')[0];
//         return value && value[0] === cmd && value.substring(1);
//       }

//       function timedAction(fn?: any, delay?: any, max?: any, reverse?: any) {
...
//         timedAction(function(index: any) {
...
//       function checkInputWidth(e?: any) {
...
//       return {
//         simulate: function (action: any) {
//           performAction(action);
//         }
//       }
//     };
//     Tabs(){
//       let tabs: any = document.querySelector('.tabs'),
//       labels: any = document.querySelector('.tabs-labels'),
//       triggers: any = document.querySelectorAll('.tabs-label'),
//       panels: any = document.querySelectorAll('.tabs-panel');

//       function activate(i?: any) {
//         triggers[i].classList.add('tabs-label--active');
//         panels[i].classList.add('tabs-panel--active');
//       }

//       function bindEvents() {
//         labels.addEventListener('click', function (e: any) {
//           var el = e.target,
//               index;
